  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      <Typography
        ...
        variant="small"
        color="blue-gray"
        className="flex items-center gap-x-2 p-1 font-medium font-bold"
      >
        <svg
          width="16"
          height="15"
        ...
        <div className="hidden items-center gap-x-2 lg:flex">
          <div className="relative flex w-full gap-2 md:w-max">
            <Input
              ...
              className=" !border-t-blue-gray-300 pl-9 placeholder:text-blue-gray-300 !bg-white  focus:!border-blue-gray-300"
              labelProps={{
