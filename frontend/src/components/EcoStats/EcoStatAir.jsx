...
import DashboardCard1 from './ClimateAndCarbonEmission/dashboard/DashboardCard1';
import CalendarHeatmapComponent from './ClimateAndCarbonEmission/dashboard/CalenderHeatMapComponent';
                ...
                <main className="grow">
                    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                        ...
                        <div className="flex flex-wrap gap-6 mb-8">
                            ...
                            <DashboardCard1
                                title="Patients With Respiratory Diseases" 
                                salesAmount={35000} 
                                salesChangePercentage={12} 
                            />
                            </div>
