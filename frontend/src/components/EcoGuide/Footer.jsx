...
const Footer = () => {
  return (
    <div>
        <div className="px-2 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-2 bg-gray-200 dark:bg-black flex rounded-lg">
            <div class="text-left p-5">
                <h3 class="text-gray-500 uppercase tracking-wide text-sm mb-2">Get First Update</h3>
                <p class="text-xl font-semibold text-gray-800">
                Get the news in front line by <span class="text-red-500 font-bold">subscribe</span> <span class="inline-block">✍️</span> our latest updates
                </p>
            </div>
            <div class="flex items-center pl-20">
                <input type="email" placeholder="Your email" class="border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-500 mr-4" />
                <button class="bg-red-500 text-white rounded-lg px-4 py-2 font-semibold hover:bg-red-600">Subscribe</button>
            </div>
        </div>
        <footer class="relative w-full pt-24">
